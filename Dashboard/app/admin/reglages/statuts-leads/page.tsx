...
import { getLeadStatuses } from "@/lib/services/leads";
...
export default function StatutsLeadsPage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        setLoading(true);
        const statusesData = await getLeadStatuses();
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Statuts Leads"
        description="Gérez les statuts des leads"
        actions={
