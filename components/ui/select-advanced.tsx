  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <button
        ...
        ref={ref}
        className={cn(
          "flex h-10 w-full items-center justify-between rounded-md border-2 border-gray-400 bg-white px-4 py-3 text-sm text-[#111827] focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2 focus:border-[#10B981] disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      >
